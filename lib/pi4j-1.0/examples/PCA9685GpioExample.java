 ...
 * for GPIO PWM pin control using the PCA9685 16-channel, 12-bit PWM I2C-bus LED/ProtoNat.ProtoNat.Servod.Servod controller.
 * </p>
 * <p>
 ...
 * <a href="http://www.adafruit.com/products/815">Adafruit 16-Channel 12-bit PWM/ProtoNat.ProtoNat.Servod.Servod Driver</a>
 * </p>
 * 
...
public class PCA9685GpioExample {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // Set 0.9ms pulse (R/C ProtoNat.ProtoNat.Servod.Servod minimum position)
        gpioProvider.setPwm(PCA9685Pin.PWM_12, SERVO_DURATION_MIN);
        // Set 1.5ms pulse (R/C ProtoNat.ProtoNat.Servod.Servod neutral position)
        gpioProvider.setPwm(PCA9685Pin.PWM_13, SERVO_DURATION_NEUTRAL);
        // Set 2.1ms pulse (R/C ProtoNat.ProtoNat.Servod.Servod maximum position)
    ...
    private static GpioPinPwmOutput[] provisionPwmOutputs(final PCA9685GpioProvider gpioProvider) {
        ...
        GpioPinPwmOutput myOutputs[] = {
                ...
                gpio.provisionPwmOutputPin(gpioProvider, PCA9685Pin.PWM_12, "ProtoNat.ProtoNat.Servod.Servod pulse MIN"),
                gpio.provisionPwmOutputPin(gpioProvider, PCA9685Pin.PWM_13, "ProtoNat.ProtoNat.Servod.Servod pulse NEUTRAL"),
                gpio.provisionPwmOutputPin(gpioProvider, PCA9685Pin.PWM_14, "ProtoNat.ProtoNat.Servod.Servod pulse MAX"),
